...
public class Volume {
    ...
    // Arithmetic
    public static Volume operator +(Volume a, Volume b) => new Volume(a.cubicMeters + b.cubicMeters);
    public static Volume operator -(Volume a, Volume b) => new Volume(a.cubicMeters - b.cubicMeters);
    public static Volume operator -(Volume x) => new Volume(-x.cubicMeters);

    // SI units
    public static Volume FromCubicMeters(double cubicMeters) => new Volume(cubicMeters);
    public double ToCubicMeters() => cubicMeters;
    public static Volume FromCubicCentimeters(double cubicCentimeters) => new Volume(cubicCentimeters * 1e-6);
    public double ToCubicCentimeters() => cubicMeters / 1e-6;
    public static Volume FromCubicMillimeters(double cubicMillimeters) => new Volume(cubicMillimeters * 1e-9);
    public double ToCubicMillimeters() => cubicMeters / 1e-9;
    public static Volume FromKiloliters(double kiloliters) => new Volume(kiloliters);
    public double ToKiloliters() => cubicMeters;
    public static Volume FromLiters(double liters) => new Volume(liters * 1e-3);
    public double ToLiters() => cubicMeters / 1e-3;
    public static Volume FromMilliliters(double milliliters) => new Volume(milliliters * 1e-6);
    public double ToMilliliters() => cubicMeters / 1e-6;
    public static Volume FromMicroliters(double microliters) => new Volume(microliters * 1e-9);
    public double ToMicroliters() => cubicMeters / 1e-9;

    // US customary liquid units
    public static Volume FromGallons(double gallons) => new Volume(gallons * 0.003785411784);
    public double ToGallons() => cubicMeters / 0.003785411784;
    public static Volume FromQuarts(double quarts) => new Volume(quarts * 0.000946352946);
    public double ToQuarts() => cubicMeters / 0.000946352946;
    public static Volume FromPints(double pints) => new Volume(pints * 0.000473176473);
    public double ToPints() => cubicMeters / 0.000473176473;
    public static Volume FromCups(double cups) => new Volume(cups * 0.0002365882365);
    public double ToCups() => cubicMeters / 0.0002365882365;
    public static Volume FromFluidOunces(double fluidOunces) => new Volume(fluidOunces * 2.95735295625e-5);
    public double ToFluidOunces() => cubicMeters / 2.95735295625e-5;
    public static Volume FromTablespoons(double tablespoons) => new Volume(tablespoons * 1.4786764828125e-5);
    public double ToTablespoons() => cubicMeters / 1.4786764828125e-5;
    public static Volume FromTeaspoons(double teaspoons) => new Volume(teaspoons * 4.92892159375e-6);
    public double ToTeaspoons() => cubicMeters / 4.92892159375e-6;

    // Imperial units
    public static Volume FromImperialGallons(double imperialGallons) => new Volume(imperialGallons * 0.00454609);
    public double ToImperialGallons() => cubicMeters / 0.00454609;

    // Other units
    public static Volume FromCubicYards(double cubicYards) => new Volume(cubicYards * 0.764554857984);
    public double ToCubicYards() => cubicMeters / 0.764554857984;
    public static Volume FromCubicFeet(double cubicFeet) => new Volume(cubicFeet * 0.028316846592);
    public double ToCubicFeet() => cubicMeters / 0.028316846592;
    public static Volume FromCubicInches(double cubicInches) => new Volume(cubicInches * 1.6387064e-5);
    public double ToCubicInches() => cubicMeters / 1.6387064e-5;
    public static Volume FromOilBarrels(double oilBarrels) => new Volume(oilBarrels * 0.158987294928);
