...
public readonly partial struct Duration {
    ...
    public static Duration FromDecades(double decades) => new(decades * 31557600e1);
    public double ToDecades() => seconds / 31557600e1;
    public static Duration FromCenturies(double centuries) => new(centuries * 31557600e2);
    public double ToCenturies() => seconds / 31557600e2;
    public static Duration FromMillennia(double millennia) => new(millennia * 31557600e3);
    public double ToMillennia() => seconds / 31557600e3;
    public static Duration FromAnnums(double annums) => new(annums * 31557600);
    public double ToAnnums() => seconds / 31557600;
    public static Duration FromMegaannums(double megaannums) => new(megaannums * 31557600e6);
    public double ToMegaannums() => seconds / 31557600e6;
    public static Duration FromGigaannums(double gigaannums) => new(gigaannums * 31557600e9);
    public double ToGigaannums() => seconds / 31557600e9;
